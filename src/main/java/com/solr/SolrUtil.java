...
public class SolrUtil {
    ...
    //指定solr服务器的地址  
    private final static String SOLR_URL = "http://localhost:8985/solr/";
...
//        solr.createSolrServer();
    ...
    public void addDoc() throws SolrServerException, IOException {
        ...
        try (HttpSolrClient solr = new HttpSolrClient.Builder(SOLR_URL + "my_core").withConnectionTimeout(10000).withSocketTimeout(60000).build()) {
            solr.add(document);
            solr.commit();
        }
    }
    ...
    public void deleteDocumentById() throws Exception {
        try (HttpSolrClient server = new HttpSolrClient.Builder(SOLR_URL + "my_core").withConnectionTimeout(10000).withSocketTimeout(60000).build()) {
            server.deleteById("8");
            //solr.deleteByQuery("*:*");
            //提交修改
            server.commit();
    ...
    public void querySolr() throws Exception {
        HttpSolrClient solrServer = new HttpSolrClient.Builder(SOLR_URL + "my_core/").withConnectionTimeout(10000).withSocketTimeout(60000).build();
